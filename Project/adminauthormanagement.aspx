<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminauthormanagement.aspx.cs" Inherits="Project.adminauthormanagement" %>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <h5 class="text-center text-primary border-bottom pb-2">
                                <i class="bi bi-person-vcard"></i> Author Details
                            </h5>
                        </div>
                    </div>
                    ...
                    <!-- Author Image -->
                       <div class="row">
                        <div class="col text-center">
                            <img width="100px" src="img/writer1.jpg"/>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <asp:TextBox CssClass="form-control" ID="txtDOB" runat="server" placeholder="Author Name"></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <h5 class="text-center text-primary border-bottom pb-2">
                                <i class="bi bi-journal-bookmark"></i> Author List
                            </h5>
                        </div>
                    </div>
